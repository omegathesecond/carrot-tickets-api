...
export type NotificationType = 'announcement' | 'dm' | 'mention' | 'friend' | 'event_reminder' | 'follow' | 'low_stock';
...
const notificationSchema = new Schema<INotification>(
  {
    ...
    type: {
      type: String,
      enum: ['announcement', 'dm', 'mention', 'friend', 'event_reminder', 'follow', 'low_stock'],
      required: true,
    },
