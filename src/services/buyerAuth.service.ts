 ...
 *
 * Buyers prove ownership of the phone number their tickets were purchased
 * against via a one-time SMS code — no passwords, no separate account row.
 * On success we mint a JWT carrying { app: 'tickets', userType: 'buyer',
