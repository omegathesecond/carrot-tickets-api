 ...
 *
 * Wired into exactly six write paths: channel message send, DM message
 * send, DM thread create, review create, follow create, community join.
 * Deliberately NOT wired into reads, ticket lookup/QR/purchase — suspension
 * blocks community participation, not access to tickets already bought.
 */
